...
@WebServlet("/admin/supplierlist")
public class SupplierListController extends AbstractServletHandler {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		req.setAttribute("suppliers", getSupplierService().findAll((page - 1) * recordsPerPage, recordsPerPage));

		int numberOfRecords = getSupplierService().numberOfRecords();
		...
		gotoToJSP("admin/supplierlist.jsp", req, resp);
